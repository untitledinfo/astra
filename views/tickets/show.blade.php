                        ...
                        <div x-data="{
                            ...
                            <div class="flex justify-center rounded-xl bg-background-secondary border border-dashed border-neutral px-6 py-2"
                                ...
                                <div x-show="uploading" class="w-full text-center">
                                    ...
                                    <div class="w-full bg-neutral rounded-xl h-3 mb-4">
                                        <div class="bg-success h-3 rounded-xl" :style="{ width: `${progress}%` }"></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="text-center">
                                        <div class="flex text-sm text-base">
                                            <label for="attachments"
                                                class="relative cursor-pointer rounded-xl font-semibold text-primary hover:text-primary/80">
                                                <span>
