...
<fieldset class="flex flex-col w-full {{ $divClass ?? '' }}" name="{{ $name }}">
    ...
    <div
        class="block px-2.5 py-2.5 w-full text-sm text-base bg-background-secondary border-2 border-neutral rounded-xl outline-none focus:outline-none focus:border-secondary transition-all duration-300 ease-in-out">
