<div class="lg:px-4 lg:py-6 flex flex-col gap-2">
    <div class="flex flex-col gap-2 md:hidden">
        ...
        <div x-data="{ activeAccordion: {{ $nav['active'] ? 'true' : 'false' }} }"
            ...
            <div class="cursor-pointer">
                <button @click="activeAccordion = !activeAccordion"
                    class="flex items-center justify-between w-full p-3 text-sm font-semibold whitespace-nowrap rounded-xl hover:bg-primary/5">
        ...
        @else
        <div class="flex items-center rounded-xl {{ $nav['active'] ? 'bg-primary/5' : 'hover:bg-primary/5' }}">
