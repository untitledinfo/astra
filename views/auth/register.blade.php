...
<div class="astra-gradient-border w-full xl:max-w-[60%] animate-astra-in">
<form
    class="flex flex-col gap-2 px-6 sm:px-14 pb-10 bg-background-secondary rounded-2xl xl:max-w-[60%] w-full"
    ...
    <div class="text-base text-center rounded-xl py-2 mt-6 text-sm">
