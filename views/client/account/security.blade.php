        ...
        <div class="bg-background-secondary rounded-xl p-4">
            ...
            <div class="flex flex-row items-center justify-between py-2 border-b border-base/50">
                <div>
                    ...
                    <p class="text-sm text-muted">{{ $session->formatted_device }}</p>
                </div>
                ...
                @else
                <span class="text-sm text-muted italic">{{ __('account.current_device') }}</span>
                @endif
            </div>
            @endforeach
        </div>
        ...
        <div class="bg-background-secondary rounded-xl p-4">
            ...
            <x-modal :title="__('account.two_factor_authentication_enable')" open="true">
                ...
                <div class="flex flex-col items-center mt-4">
                    ...
                    <p class="text-muted mt-2 text-sm text-center">
