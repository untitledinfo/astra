<div class="container mt-14">
    ...
    <div class="px-2">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <span class="bg-primary flex items-center justify-center font-semibold rounded-xl size-5 text-sm text-white">
                {{ $agreements->count() }}
            </span>
        </div>

        @foreach($agreements as $agreement)
        <div class="bg-background-secondary border border-neutral p-4 rounded-xl mb-4 hover:bg-background-secondary/80 transition-colors">
        ...
        @endforeach
        @else
        <div class="bg-background-secondary border border-neutral p-6 rounded-xl text-center">
        ...
        <a href="{{ route('invoices.show', $transaction->invoice) }}" wire:navigate>
            <div
                class="bg-background-secondary hover:bg-background-secondary/80 border border-neutral p-1 rounded-xl mb-4">
                <div class="flex items-center justify-between">
